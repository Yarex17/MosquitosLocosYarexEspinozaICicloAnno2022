...
public void actualizar() {
	...
	for (int i = 0; i < this.nivel.getCuadras().get(0).getEdificios().size(); i++) {
			...
			if (this.nivel.getCuadras().get(0).getEdificios().get(i).isEntra()) {
				...
				if (!this.nivel.getCuadras().get(0).getEdificios().get(1).isEntra()&&!this.nivel.getCuadras().get(0).getEdificios().get(2).isEntra()) {
					this.nivel.getCuadras().get(0).getEdificios().get(i).collison(personaje);
	...
	for (int i = 0; i < this.nivel.getCuadras().get(0).getEdificios().size(); i++) {
		...
		if (this.nivel.getCuadras().get(0).getEdificios().get(i).isEntra()) {
			...
			for (int j = 0; j < this.balas.size(); j++) {//actualizacion de colision de la bala con mosquito internos
				...
				for (int j2 = 0; j2 < this.nivel.getCuadras().get(0).getEdificios().get(i).getMosquitos()
						.size(); j2++) {
					if (this.balas.get(j)
							.colision(this.nivel.getCuadras().get(0).getEdificios().get(i).getMosquitos().get(j2))) {
						this.balas.remove(j);
			...
			for (int j = 0; j < this.balas.size(); j++) {//actualizacion de colision de la bala con criadera internos
				
			
				for (int f = 0; f < this.nivel.getCuadras().get(0).getEdificios().get(i).getCriaderos().size(); f++) {
					if (this.balas.get(j)
 ...
 break;
			...
			for (int j = 0; j < this.nivel.getCuadras().get(0).getMosquitos().size(); j++) {//actualizacion de colision de  mosquito externos
...
//						} //
			...
			for (int j = 0; j < this.balas.size(); j++) {
				...
				for (int k = 0; k < this.nivel.getCuadras().get(0).getMosquitos().size(); k++) {//actualizacion de colision de la bala con mosquito
				...
				for (int j = 0; j < this.balas.size(); j++) {
					for (int k = 0; k < this.nivel.getCuadras().get(0).getCriaderos().size(); k++) {//actualizacion de colision de la bala con criadera
